...
df1.hpc$Global_reactive_power <- as.numeric(df1.hpc$Global_reactive_power)
df1.hpc$Voltage <- as.numeric(df1.hpc$Voltage)
df1.hpc$Global_intensity <- as.numeric(df1.hpc$Global_intensity)
str(df1.hpc)
par(mfcol=c(2,2))
#
plot(df1.hpc$DataTime, df1.hpc$Global_active_power,
...
legend("topright", lty=1, col=c("black","red","blue"),
    ...
    bty = "n", cex = 0.8)
#
plot(df1.hpc$DataTime, df1.hpc$Voltage,
    type="l", xlab="datetime", ylab="Voltage")
#
plot(df1.hpc$DataTime, df1.hpc$Global_reactive_power,
    type="l", xlab="datetime", ylab="Voltage")
#
